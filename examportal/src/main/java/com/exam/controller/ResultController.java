...
public class ResultController {
    ...
    public ResponseEntity<PageResponse<List<ResultDTO>>> getAllResultOfUser(@PathVariable("userId") Long userId,Pageable pageable) {
        try {
            PageResponse<List<ResultDTO>> results = this.resultService.getAllResultOfUserById(userId,pageable);
